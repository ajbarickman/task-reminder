...
import { ShieldCheck, Sparkles, ArrowRight, CheckCircle2, KeyRound } from "lucide-react";
    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 flex flex-col justify-center items-center px-4 py-12">
      <div className="max-w-md w-full space-y-6">
        ...
        <div className="text-center space-y-2">
          <div className="w-16 h-16 rounded-3xl bg-gradient-to-tr from-indigo-600 via-blue-600 to-amber-400 mx-auto flex items-center justify-center text-white shadow-xl shadow-indigo-500/25">
          ...
          <p className="text-sm text-zinc-600 dark:text-zinc-400">
            Keep chores, homework, and tests in sync between you and your son.
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl p-6 sm:p-8 shadow-xl shadow-zinc-200/50 dark:shadow-none space-y-6">
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                <ShieldCheck className="w-5 h-5 mx-auto mb-1 text-indigo-600 dark:text-indigo-400" />
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3.5 px-4 rounded-2xl border border-zinc-300 dark:border-zinc-700 bg-white hover:bg-zinc-50 dark:bg-zinc-800 dark:hover:bg-zinc-750 text-zinc-800 dark:text-white font-bold text-sm shadow-sm active:scale-[0.98] transition-all disabled:opacity-50"
          >
